# Generated by Django 2.2 on 2021-04-30 21:46
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('assays', '0011_auto_20210416_1146'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assayid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='iinflc06s', to='assays.Assay')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('acquisition_settings', models.TextField(blank=True, null=True)),
                ('comment', models.TextField(blank=True, null=True)),
                ('assayid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='iinflc05s', to='assays.Assay')),
                ('mid', models.ForeignKey(db_column='mid', on_delete=django.db.models.deletion.CASCADE, to='assays.Mouse')),
            ],
            options={
                'managed': True,
